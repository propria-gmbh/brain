...
- [ ] Написать в налоговую Райникендорф — нужно запустить или ликвидировать ИП [perekur]

### Календарь сегодня

- [ ] Wertstoffe (BSR) — вынести утром (08:00)
- [ ] Call ECOM GOOGLE MM (14:00–15:00)

### Someday — приоритет

- [ ] Найти автомобиль в лизинг или в абонемент (с сентября 2026)
- [ ] Сделать для Мити подборку аккаунтов в инсте и магазинов по льну
- [ ] Изучить сервисы pythago.io и TrustPilot — оценить применимость для себя
- [ ] Зарегистрировать GMC на физика
- [ ] Посмотреть запись 1M call в AB Inner Circle
- [ ] Написать Lanyou и Hongda — запрос на образцы и условия OEM для Casa Gian

## Перекур / На улице

- [ ] Найти другого Hausarzt в Берлине для справки IYT (Wolf в отпуске до начала июля)
- [x] 2026-06-16 Пешком к офтальмологам на Nordmeile — справка IYT; если откажут, поискать ещё
