...
| FitX Deutschland GmbH (мандат 1) | MLREF2906959 | €24.00/мес | сделано — уведомлён |
| FitX Deutschland GmbH (мандат 2) | MLREF2906960 | €24.00/мес | сделано — уведомлён |
| DB Vertrieb GmbH | Abo 6443 4752 3 | €63.00/мес | сделано — уведомлён |
...
Один раз обновить привязанный банковский счёт в PayPal — закрывает все три позиции. **Сделано — привязанный счёт в PayPal обновлён.**

| Получатель | Сумма | Комментарий |
|---|---|---|
| Spotify AB | €12–22/мес (нестабильно) | Списывается через PayPal (PP.4523.PP) — закрыто через обновление PayPal |
| Paddle.net | €3.10–3.90/мес | Списывается через PayPal (PP.4523.PP) — закрыто через обновление PayPal |
| PayPal *Rivertygmbh | переменная | Рассрочки за покупки, тоже через PayPal — закрыто через обновление PayPal |
